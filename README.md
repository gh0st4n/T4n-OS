...
- **Base**: Void Linux
- **Init system**:
  - `runit` (default & direkomendasikan)
  - `systemd` (opsional)
...
Walaupun berangkat dari server, **T4n OS dapat digunakan untuk kebutuhan umum**, antara lain:

### 🌐 Browsing
- Firefox / Chromium
- Ringan, cepat, tanpa service tidak perlu
- Cocok untuk daily browsing & research
...
- Cocok untuk:
  ...
  - Game Linux-native
- Catatan:
  - User **harus paham dependency & driver GPU**
  - Bukan plug-and-play
...
- Cocok untuk:
  ...
  - Networking
  - Server & DevOps dasar
- Tidak menyembunyikan kompleksitas → **belajar beneran**

### 🧑‍💼 Office (Coming Soon)
- PDF tools
- Email client
- Ringan untuk kerja kantoran sehari-hari
...
**VUR** dibuat untuk:
- Menutup kekurangan package Void official
- Menyediakan:
  - Tool server
  - Tool desktop
  - Utility power-user
